    ...
    <div className="min-h-screen bg-slate-100 flex flex-col items-center">
      ...
      <div className="w-full bg-[#351C15] pt-12 pb-24 px-4 flex flex-col items-center text-center shadow-md">
        ...
        <p className="text-amber-200/90 text-xs sm:text-sm mt-1.5 font-medium max-w-md">
          Enterprise Supply Chain Telematics Portal
        </p>
      </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-6 sm:p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-xs text-slate-500 mt-1">
              Sign in to access your logistics control dashboard
            </p>
          </div>

          {errorMsg && (
            <div className="mb-4 p-3.5 bg-rose-50 border border-rose-300 rounded-xl text-rose-800 text-xs flex items-center gap-2.5 font-medium">
